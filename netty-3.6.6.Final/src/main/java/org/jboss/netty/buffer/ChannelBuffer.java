...
public interface ChannelBuffer extends Comparable<ChannelBuffer> {
     ...
     * This method does not modify {@code readerIndex} or {@code writerIndex} of
     * this buffer.<br/>
     * 此方法会复制当前ChannelBuffer对象封装的底层数据(指定子区域的数据)，而非共享这些数据，
     * 返回的channelBuffer和当前channelBuffer完全互不影响。{@link #copy()}方法也是一样的
     */
     ...
     * This method does not modify {@code readerIndex} or {@code writerIndex} of
     * this buffer.<br/>
     * 此方法不会复制当前ChannelBuffer对象封装的底层数据(指定子区域的数据)，而是共享这些数据，
     * 但是返回的channelBuffer和当前channelBuffer维护各自独立的索引和标记，然而它们仍会相互影响。
     */
     ...
     * This method does not modify {@code readerIndex} or {@code writerIndex} of
     * this buffer.<br/>
     * 此方法不会复制当前ChannelBuffer对象封装的所有底层数据，而是共享所有数据，但是返回的channelBuffer
     * 和当前channelBuffer维护各自独立的索引和标记，然而它们仍会相互影响。
     */
